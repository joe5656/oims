 ...
 * @author ezouyyi
 */
public class MemberTable extends Db_table{
    static public String getDerivedTableName()
    {
        return "MemberTable";
    }
    public MemberTable(DataBaseManager dbm)
    {
        super("MemberTable", dbm, Table_Type.TABLE_TYPE_REMOTE);
        ...
        super.registerColumn("credits", Db_publicColumnAttribute.ATTRIBUTE_NAME.DOUBLE,  Boolean.FALSE,   Boolean.FALSE,  Boolean.FALSE, null);
        super.registerColumn("memberCat", Db_publicColumnAttribute.ATTRIBUTE_NAME.VARCHAR60,  Boolean.FALSE,   Boolean.FALSE,  Boolean.FALSE, null);
        ...
        super.registerColumn("email", Db_publicColumnAttribute.ATTRIBUTE_NAME.VARCHAR60, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null);
        ...
        super.registerColumn("memberId", Db_publicColumnAttribute.ATTRIBUTE_NAME.INTEGER, Boolean.TRUE, Boolean.TRUE,  Boolean.TRUE, null);
    }
                            ...
                            Integer deptId, String gender)
    {
        ...
        {
            result.setErrInfo("会员信息不合法，性别请填写“男/女”");
            return result;
        }
